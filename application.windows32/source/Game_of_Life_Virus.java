...
public class Game_of_Life_Virus extends PApplet {
...
float infectionProb = 0.05f;
float transferProb = 0.5f;
float deathProb = 0.125f;
float spawnSev = 0.5f;
int spawnDur = 4;
float maxSev = 3;
...
public void toggleLoop(boolean...forcedState) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Game_of_Life_Virus" };
    if (passedArgs != null) {
